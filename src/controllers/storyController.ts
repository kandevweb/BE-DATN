...
class storyController {
  ...
  async fetchAllStory(req: Request, res: Response) {
    const data = await storyService.fetchAllStory()
  ...
  async updateStory(req: Request, res: Response) {
    ...
    const data = await storyService.updateStory(storyId, storyData)
    sendResponseSuccess(res, data)
  }
   // Xóa Story
   async deleteStory(req: Request, res: Response) {
    const { storyId } = req.params
    const data = await storyService.deleteStory(storyId)
    sendResponseSuccess(res, data)
  }
   // Chi tiết tin
